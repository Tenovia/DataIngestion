...
def main(client,date,full_date):
  ...
  report_query = (adwords.ReportQueryBuilder()
                  .Select('CampaignName','CampaignStatus','Engagements',
                             ...
                             'AllConversions') # these are the fields we are using to generate our report
