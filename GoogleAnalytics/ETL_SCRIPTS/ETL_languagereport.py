...
for x in range(1,9):
    ...
    data = 's3://paragon-datalake/googleanalytics/landing/languagereport/languagereport'+date1+'.csv'
    ...
    data.write.mode("overwrite").parquet('s3://paragon-datalake/googleanalytics/processing/languagereport/languagereport'+date1)
