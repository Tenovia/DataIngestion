...
for x in range(1,9):
    ...
    data = 's3://paragon-datalake/googleanalytics/landing/countryreport/countryreport'+date1+'.csv'
    ...
    data.write.mode("overwrite").parquet('s3://paragon-datalake/googleanalytics/processing/countryreport/countryreport'+date1)
